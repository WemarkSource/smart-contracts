...
/**
 * @title Vested token, written by OpenZeppelin as part of the zeppelin-solidity project.
 * Source can be found here: https://github.com/OpenZeppelin/zeppelin-solidity/blob/v1.3.0/contracts/token/VestedToken.sol
 *
